...
public function channelReadJson(ReadableChannel channel) returns @tainted readonly & json|Error {}
...
public function channelWriteJson(WritableChannel channel, json content) returns @tainted Error? {}
