...
/**
 * Interface to be implemented by all IO function analysis rules.
 */
public interface IoFunctionRule {

    /**
     * Analyze the given IO function call and report issues if any.
     *
     * @param context Context information required to analyze the function call
     */
    void analyze(IoFunctionContext context);
     ...
     */
    boolean isApplicable(IoFunctionContext context);
}
