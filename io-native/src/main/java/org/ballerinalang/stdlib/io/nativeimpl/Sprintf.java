...
public class Sprintf {
    ...
    private static final String ILLEGAL_FORMAT_CONVERSION = "illegal format conversion";
    private static final String UNKNOWN_FORMAT_CONVERSION = "unknown format conversion";
                ...
                try {
                    ...
                    switch (formatSpecifier) {
                        ...
                        case 'f':
                            if (ref == null) {
                                throw ErrorCreator
                                        .createError(StringUtils.fromString(ILLEGAL_FORMAT_CONVERSION + " '" +
                        ...
                        default:
                            ...
                            throw ErrorCreator
                                    .createError(StringUtils.fromString(UNKNOWN_FORMAT_CONVERSION + " '" +
                                                                                format.getValue().charAt(j) + "'"));
                    }
                } catch (IllegalFormatConversionException e) {
                    throw ErrorCreator.createError(StringUtils.fromString(ILLEGAL_FORMAT_CONVERSION + " '" +
                                                                                  format.getValue().charAt(j) + " != " +
